...
from dotenv import load_dotenv # ✅ Using the standard dotenv package already in your project environment
import dj_database_url
# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent

# 🔌 Load the environment variables from your local .env file explicitly
# This instantly grabs SECRET_KEY, GEMINI_API_KEY, and PostgreSQL configurations
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [], # Empty list disables all auto-auth
}
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'ntrca_db'),
